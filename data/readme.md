...
stock_index_prices.csv

5: OPERATIONS IN PANDAS, PART II – GROUPING, MERGING, AND RESHAPING OF DATA

euro_winners.csv
goal_stats_euro_leagues_2012-13.csv
PlantGrowth.csv
tech_stockprices.csv
us_index_data.csv

6: MISSING DATA, TIME SERIES, AND PLOTTING USING MATPLOTLIB

GOOG_tickdata_20140527.csv
ibm-common-stock-closing-prices-1959_1960.csv
